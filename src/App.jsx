...
// Levels
const presetLevels = [
  { name: "Credential Phishing Campaign", goal: "data_exfiltrated", initial_state: [], optimal: 4, allowed: ["phishing","login","escalate","exfiltrate"], hint: "Basic credential theft" },
  { name: "Credential Stuffing Attack", goal: "data_exfiltrated", initial_state: [], optimal: 4, allowed: ["brute","login","escalate","exfiltrate"], hint: "Guess passwords" },
  { name: "Open S3 Bucket Exposure", goal: "data_exfiltrated", initial_state: ["admin_access"], optimal: 1, allowed: ["exfiltrate"], hint: "Misconfigured system" },

  { name: "Credential Dumping Attack", goal: "data_exfiltrated", initial_state: [], optimal: 5, allowed: ["phishing","login","credential_dump","escalate","exfiltrate"], hint: "Extract credentials" },

  { name: "Persistence Attack", goal: ["data_exfiltrated","persistent_access"], initial_state: [], optimal: 5, allowed: ["phishing","login","persistence","escalate","exfiltrate"], hint: "Maintain access" },

  { name: "Lateral Movement Attack", goal: "data_exfiltrated", initial_state: [], optimal: 5, allowed: ["phishing","login","lateral_move","privilege_chain","exfiltrate"], hint: "Move across network" },

  { name: "Multi-Stage Breach", goal: "data_exfiltrated", initial_state: [], optimal: 6, allowed: ["phishing","login","credential_dump","lateral_move","privilege_chain","exfiltrate"], hint: "Combine techniques" },

  { name: "Data Staging Attack", goal: "data_exfiltrated", initial_state: [], optimal: 6, allowed: ["phishing","login","escalate","data_staging","stealth_exfiltrate"], hint: "Stage data first" },

  { name: "Stealth Exfiltration", goal: "data_exfiltrated", initial_state: [], optimal: 7, allowed: ["phishing","login","persistence","escalate","data_staging","stealth_exfiltrate"], hint: "Avoid detection" },

  { name: "Advanced Persistent Threat", goal: "data_exfiltrated", initial_state: [], optimal: 8, allowed: Object.keys(nodes), hint: "Full lifecycle attack" }
];
